        ...
        >
          ...
          <label className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              rows={5}
              spellCheck={false}
              className="rounded-lg border border-slate-300 bg-white px-3 py-2 font-mono text-sm text-slate-900 shadow-sm focus:border-brand-600 focus:outline-none focus:ring-2 focus:ring-brand-600/20"
            />
          </label>
          <div>
      ...
      <AppShell>
        <div className="mx-auto max-w-5xl p-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900">Vault items</h1>
